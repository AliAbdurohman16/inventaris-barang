                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <div class="dropzone required" input="#ctrl-Gambar_Barang" fieldname="Gambar_Barang"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" filesize="3" maximum="5">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-Tahun_Perolehan"  value="<?php  echo $this->set_field_value('Tahun_Perolehan',""); ?>" type="text" placeholder="Enter Tahun Perolehan"  required="" name="Tahun_Perolehan"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <label class="control-label" for="nama_user">Nama Pengirim<span class="text-danger">*</span></label>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-nama_user"  value="<?php  echo $this->set_field_value('nama_user',""); ?>" type="text" placeholder="Enter Nama Pengirim"  required="" name="nama_user"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
