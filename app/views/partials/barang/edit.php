                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-Tahun_Perolehan"  value="<?php  echo $data['Tahun_Perolehan']; ?>" type="text" placeholder="Enter Tahun Perolehan"  required="" name="Tahun_Perolehan"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
