                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <th class="td-Tgl_Penyusutan"> Tanggal Penyusutan</th>
                                            <th class="td-btn"></th>
                                        </tr>
                                    </thead>
                                    <?php
                                    ...
                                    <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-Gambar_Barang">
                                                <?php Html :: page_img($data['Gambar_Barang'],50,50,1); ?></td>
                                            ...
                                            <td class="td-Tgl_Penyusutan">
                                                <span <?php if($can_edit){ ?>
                                                    data-value="<?php echo $data['Tgl_Penyusutan']; ?>"
                                                    data-pk="<?php echo $data['Id_Barang'] ?>"
                                                    data-url="<?php print_link("barang/editfield/" . urlencode($data['Id_Barang'])); ?>"
                                                    data-name="Tgl_Penyusutan" data-title="Enter Tanggal Penyusutan"
                                                    data-placement="left" data-toggle="click" data-type="text"
                                                    data-mode="popover" data-showbuttons="left" class="is-editable"
                                                    <?php } ?>>
                                                    <?php echo $data['Tgl_Penyusutan']; ?>
                                                </span>
                                            </td>
                                            <th class="td-btn">
                                                <?php if($can_view){ ?>
                                                ...
                                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn"
                                                    ...
                                                    href="<?php print_link("barang/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>"
