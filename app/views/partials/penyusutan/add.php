                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                <div class="col-sm-4">
                                                                    <label class="control-label" for="Tgl_Penyusutan">Tanggal Penyusutan <span class="text-danger">*</span></label>
                                                                </div>
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-Tgl_Penyusutan"  value="<?php  echo $this->set_field_value('Tgl_Penyusutan',""); ?>" type="text" placeholder="Enter Tgl Penyusutan" required="" name="Tgl_Penyusutan"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
