                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-Tgl_Penyusutan">
                                        <th class="title"> Tanggal Penyusutan: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['Tgl_Penyusutan']; ?>" 
                                                data-pk="<?php echo $data['Id_Barang'] ?>" 
                                                data-url="<?php print_link("barang/editfield/" . urlencode($data['Id_Barang'])); ?>" 
                                                data-name="Tgl_Penyusutan" 
                                                data-title="Enter Tgl Penyusutan" 
                                                data-placement="left" 
                                                data-toggle="click" 
                                                data-type="text" 
                                                data-mode="popover" 
