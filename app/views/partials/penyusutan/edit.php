                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-Tgl_Penyusutan"  value="<?php  echo $data['Tgl_Penyusutan']; ?>" type="text" placeholder="Enter Tanggal Penyusutan" srequired="" name="Tgl_Penyusutan"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
