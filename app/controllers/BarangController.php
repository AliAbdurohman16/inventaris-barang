...
class BarangController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if (@$request->act == "penyusutan"){
			$page_title = $this->view->page_title = "Penyusutan";
			$tablename = "penyusutan";
			...
			$search_condition = "(
				...
				".$tablename.".Id_Kategori LIKE ? OR 
				".$tablename.".Nama_Barang LIKE ? OR 
				".$tablename.".Merek LIKE ? OR 
				".$tablename.".Spesifikasi LIKE ? OR 
				".$tablename.".Gambar_Barang LIKE ? OR 
				".$tablename.".Jumlah_Aset LIKE ? OR 
				".$tablename.".Nilai_Per_Aset LIKE ? OR 
				".$tablename.".Id_Ruangan LIKE ? OR 
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy($tablename.".Id_Barang", ORDER_TYPE);
		}
		if($fieldname){
		...
		if(!empty($request->filter)){
			redirect('barang/index/Id_kategori/'.$request->filter);
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Id_Kategori","Nama_Barang","Merek","Spesifikasi","Gambar_Barang","Jumlah_Aset","Nilai_Per_Aset","Id_Ruangan","Id_Kondisi","Asal_Perolehan","Tahun_Perolehan", "nama_user");
	...
	function delete($rec_id = null){
		...
		$arr_rec_id = $rec_id;
		if (@$_GET['ac'] == "penyusutan"){
			$db->where("penyusutan.Id_Barang", $arr_rec_id);
			$bool = $db->delete("penyusutan");
		}else{
		...
		if (@$_GET['ac'] == "penyusutan"){
			return	$this->redirect("barang?act=penyusutan");
		}else{
			return	$this->redirect("barang");
		}
	}
