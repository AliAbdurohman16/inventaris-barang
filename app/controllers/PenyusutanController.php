 ...
 * @category  Controller
 */
class PenyusutanController extends SecureController{
	function __construct(){
		parent::__construct();
		$this->tablename = "penyusutan";
	}
	/**
     * List page records
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				barang.Tahun_Perolehan LIKE ? OR
				barang.Tgl_Penyusutan LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Id_Kategori","Nama_Barang","Merek","Spesifikasi","Gambar_Barang","Jumlah_Aset","Nilai_Per_Aset","Id_Ruangan","Id_Kondisi","Asal_Perolehan","Tahun_Perolehan", "Tgl_Penyusutan");
			...
			$this->sanitize_array = array(
				...
				'Tgl_Penyusutan' => 'sanitize_string'
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("Id_Barang","Id_Kategori","Nama_Barang","Merek","Spesifikasi","Gambar_Barang","Jumlah_Aset","Nilai_Per_Aset","Id_Ruangan","Id_Kondisi","Asal_Perolehan","Tahun_Perolehan", "Tgl_Penyusutan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'Id_Kategori' => 'required',
